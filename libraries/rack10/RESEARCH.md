...
### M6 screw clearance — **6.6 mm** — tier [B] ISO 273 medium fit, repo precedent
...
| M6 clearance | 6.6 | [B] | ISO 273 medium fit, named standard (not fetched); LabRax confirms M6 is its actual fastener |
